-- Add provider/source identifiers to content_items and make payload minimal.
...
INSERT INTO "new_content_items" ("category_id", "cover_url", "created_at", "id", "is_active", "rating", "release_date", "synopsis", "title", "updated_at")
SELECT "category_id", "cover_url", "created_at", "id", "is_active", "rating", "release_date", "synopsis", "title", "updated_at"
FROM "content_items";
